...
<div class="container">
<?php
echo '<h1><legend>Connexion</legend></h1>';
...
else
{
	...
	if ($data['membre_mdp'] == md5($_POST['password'])) // Acces OK !
	{
	    ...
	    $message = '<p>Bienvenue '.$data['membre_pseudo'].', 
			...
			<p>Vous allez être redirigé vers la page principal dans <span id=\'compteur\'>5</span> 5 secondes!</a> 
			</p><!--meta http-equiv="refresh" content="5; index.php"-->';
	}
	else // Acces pas OK !
	{
