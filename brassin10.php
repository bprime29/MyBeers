<?php
session_start();
$titre = "Black IPA Amarillo/Cascade";
$description = "Recette de ma prmière IPA avec dry hopping";
...
$name = "Brassin 10 - Black IPA Amarillo/Cascade";
...
<div class="container font_white">
    ...
    <div class="starter-template">
        <h1>Brassin 10 - Black IPA Amarillo/Cascade</h1>
        <p class="lead">Voici la recette de ma première Black IPA! J'ai réalisé un cold steeping avec du Carafa 3 (1500EBC). Je l'ai fait infuser dans 4l d'eau au réfrigérateur pendant 24h et j'ai rajouter le "goudron" obtenu en fin d'ébulition.</p>
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <ul class="timeline">
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-body">Ajouter les <strong>25 g d'Amarillo</strong>et les <strong>20 g de Cascade</strong></div>
                        </div>
                    </li>
                    <li>
        ...
        <div class="tab-pane" id="ferment">
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <table class="table table-borderless table-condensed table-hover">
                    ...
                    <tr>
                        <td colspan="2"><strong><em>Dry hopping</em></strong> <em><strong>:</strong></em>Ajouter <strong>40g de Cascade</strong> 5 jours avant la mise en bouteille</td>
                    </tr>
                    <tr>
